...
if ask "Do you want to apply MacOS system settings?" Y; then
  ...
  defaults write -g com.apple.Accessibility KeyRepeatDelay 0.5
  defaults write -g com.apple.Accessibility KeyRepeatEnabled 1
  defaults write -g com.apple.Accessibility KeyRepeatInterval 0.083333333
  ...
  printf "Skipping setting up MacOS system settings\n"
fi
